...
/* @var $searchModel amilna\iyo\models\LayerSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Layers');
...
<div class="layer-index">
    ...
    <?= GridView::widget([
		...
		'panel' => [
			...
			'heading' => '<i class="glyphicon glyphicon-th-list"></i>  '.Yii::t('app', 'Layer'),			
			'before'=>Html::a(
